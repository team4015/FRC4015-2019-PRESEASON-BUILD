...
/**
* TapeSensorMKII class.
*
* <p>An OpenCV pipeline generated by GRIP.
*
* @author GRIP
*/
public class TapeSensorMKII implements edu.wpi.first.vision.VisionPipeline {
	...
	@Override	public void process(Mat source0) {
		...
		double[] hslThresholdHue = {0.0, 180};
		double[] hslThresholdSaturation = {0.0, 255.0};
		double[] hslThresholdLuminance = {145, 255.0};
